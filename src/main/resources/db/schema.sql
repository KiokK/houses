...
(
    person_id BIGINT               NOT NULL CONSTRAINT fk_person_history_id REFERENCES person (id) ON DELETE CASCADE,
    house_id  BIGINT               NOT NULL CONSTRAINT fk_house_history_id  REFERENCES house (id)  ON DELETE CASCADE,
